...
document.addEventListener('DOMContentLoaded', function() {
    ...
    botaoAdicionar.addEventListener('click', function() {
        ...
        // Verificar limite de 3 produtos
        if (produtosExistentes.length >= 3) {
            alert('Você já adicionou o número máximo de produtos (3). Remova um para adicionar outro.');
            return;
        }

        const novoNumeroProduto = produtosExistentes.length + 1;
    ...
    // responsável por manter o bacgroud conforme as imagens add//
